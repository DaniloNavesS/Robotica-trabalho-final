...
# Salvar os pontos percorridos em um arquivo CSV
filename = "trajetoria_ur3v2.csv"
with open(filename, mode='w', newline='') as file:
    writer = csv.writer(file)
    writer.writerow(['x_out', 'y_out', 'z_out'])
    for ponto in square_points:
        writer.writerow(ponto)
print(f"Trajetória salva em {filename}")

# (Opcional) Para plotar a trajetória automaticamente, descomente as linhas abaixo se plot_trajetoria.py suportar:
# import plot_trajetoria
# plot_trajetoria.plot_csv(filename)
